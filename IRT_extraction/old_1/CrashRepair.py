...
class CrashRepair:
    ...
    def find_crash_segments(self):
        ...
        for crash_idx in crash_transitions:
            if crash_idx < self.window_frame_count or crash_idx >= len(self.data) - self.window_frame_count:
                continue
                
            pre_crash = self.data.iloc[crash_idx - self.window_frame_count:crash_idx]
            post_crash = self.data.iloc[crash_idx:crash_idx + self.window_frame_count]
