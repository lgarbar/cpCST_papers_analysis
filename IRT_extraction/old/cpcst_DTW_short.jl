...
# ╔═╡ 1f746856-8b22-11ef-1254-13c1e5df0759
begin
	using CSV
	using Glob
	using Query
...
# ╔═╡ f242407d-f977-4210-a6e3-eec8245ca1ec
md"""
!!! info "Utility Functions"
"""

# ╔═╡ 53c36764-17a8-4c30-af72-fe295b243b82
begin
	function ffill!(vec)
...
# ╔═╡ 73887a8a-47bd-4070-bbc3-1fcb8df581f4
md"Getting IRT for CPT Participant Data"

# ╔═╡ 7d2a5f27-3ed1-4eee-927c-602bc0a85c2e
function process_files_with_irt(flist, outpath="/Users/danielgarcia-barnett/Desktop/Coding/cpCST_data_analysis/IRT_extraction/test_data/jan_28_2024/test_1/IRT_data/cleaned_data_old_dtw/", overwrite::Bool=false)
...
# ╔═╡ 0357b081-164a-4f93-97f0-055363c8afcc
flist = Glob.glob("*CPT_run*.csv", "/Users/danielgarcia-barnett/Desktop/Coding/cpCST_data_analysis/IRT_extraction/test_data/jan_28_2024/test_1/cpCST_data/cleaned_data/")

# ╔═╡ 85c525e8-c457-42ff-a025-3620b15e41b2
# begin
# 	outpath = "/Users/danielgarcia-barnett/Desktop/Coding/cpCST_data_analysis/data/dtw_data/"
	
# 	for fil in flist[1:11]
# 		w = 100
# 		filname = split(fil, '/')[end]
# 		outfile = outpath*"proc_"*filname
# 		Df_temp = load_cpCST_csv(fil)
...
# ╔═╡ 6df84813-abfa-4b73-b2c7-89b51993bdb2
begin
...
# ╔═╡ 53c5f260-2337-4012-bfdc-b326f6ef8455
...
manifest_format = "2.0"
project_hash = "2ef7d129b807eabcb408a0d2f86d232263e2cd54"
...
git-tree-sha1 = "01068e51cb1695b8956441860d416c894278e858"
