...
infil = "/Users/stan/Projects/CSTCPT_analyses/data/raw/MoBI/sub-M10925715_ses-MOBI1_task-CPT_run-1_events.csv"
...
# ╔═╡ ebbee850-8847-40ad-a61e-6841c64085d1
...
flist = Glob.glob("*CPT_run*.csv", "/Users/stan/Projects/CSTCPT_analyses/data/raw/MoBI/")
...
function pointwise_lag(
    # x::SentinelArrays.ChainedVector{Float64, Vector{Float64}},
    # y::SentinelArrays.ChainedVector{Float64, Vector{Float64}},
	x,
	y,
    ...
    for i in 1:m
        ...
        for j in search_start:search_end
            distance = dtw(x[max(1, i-1):min(m, i+1)], y[max(1, j-1):min(n, j+1)])
...
# ╔═╡ 8a299bb1-44ec-4098-b58a-481a82943570
typeof(df.stim_pos)

# ╔═╡ 01c4934a-f5c5-4f0a-b3d5-12f8fc49baa5
timelag = pointwise_lag(df.stim_pos, df.user_pos, 30)
...
CSV.write("/Users/stan/Projects/CSTCPT_analyses/notebooks/testing2.csv", df)
